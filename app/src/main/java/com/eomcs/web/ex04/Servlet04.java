...
public class Servlet04 extends GenericServlet {
  ...
  public void service(ServletRequest req, ServletResponse res)
    ...
    //    - 실무에서는 아직도 appache.org에서 제공하는 라이브러리를 계속 사용하는 곳도 있다.
    //    - 그래서 Servlet 3.0에서 제공하는 방법 뿐만 아니라
    //    - 2) 방법도 알고 있어야 한다.
    ...
    /// *
    // 
    // => DiskFileItemFactory는 각 파트 데이터를 분석하여 FileItem 객체에 담아주는 일을 한다.
    //    직접 ServletFileUpload 객체의 일을 보조한다.
    ...
    try {
      // parseRequest()
      // => 클라이언트가 보낸 멀티 파트 데이터를 읽어서
      //    FileItem 객체 배열로 뽑아내는 일을 한다.
